...
const NumberField = ({value, placeholder, supportingText, isError, onChange}:{value: any , placeholder: string, supportingText?: string, isError?: Boolean, onChange: (e: any) => void;}) => {
